                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('start_of_the_course') is-invalid @enderror" id="start_of_the_course" name="start_of_the_course">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="end_of_the_course" class="form-label">Date end</label>
                                    <input type="date" class="form-control  @error('end_of_the_course') is-invalid @enderror" id="end_of_the_course" name="end_of_the_course">
                                </div>
                            </div>
                        </div>
                            <div class="mb-3">
