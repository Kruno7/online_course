            ...
            <div class="container text-white">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.courses.index') }}">{{ __('courses') }}</a>
                        </li>
                        @endcan
                        @can('teacher-routes')
                       
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('teacher.quiz.index') }}">{{ __('quiz') }}</a>
                        </li>
                       
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('teacher.quiz.qa-create') }}">{{ __('questions/answers') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('teacher.lessons.index') }}">{{ __('lessons') }}</a>
                        </li>
                        @endcan
